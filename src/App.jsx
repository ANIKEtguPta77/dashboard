...
function App() {
  ...
  useEffect(() => {
    ...
    google.accounts.id.initialize({
      client_id:
        "827813005695-8i939h9cmg26vt48c9itqnaorjr43ife.apps.googleusercontent.com",
      callback: handleCall,
    });
    ...
    <div>
      {Object.keys(user).length !== 0 ? (
        ...
        <div className="flex md:flex-row flex-col w-full h-screen">
          <div className="lg:h-screen h-1/5 md:h-screen w-full md:w-1/3 bg-black flex flex-col justify-center items-center">
            <strong className="text-6xl font-extrabold text-white flex justify-center text-justify">
              Board.
            </strong>
          </div>
          <div className="h-4/5 md:h-screen md:w-2/3 flex items-center justify-center bg-neutral-300 w-full">
            <div className="flex flex-col justify-start gap-2 w-1/2">
              ...
              <div className="flex flex-col bg-white p-4 font-mono ... gap-4 rounded-lg">
                <div>
                  ...
                  <input
                    type="email"
                    className="bg-neutral-100 h-8 w-full rounded"
                    placeholder="......"
                    name="email"
                  />
                </div>
                ...
                <button className="bg-black text-white font-bold rounded-md h-10">
                  Sign In
                </button>
              </div>
